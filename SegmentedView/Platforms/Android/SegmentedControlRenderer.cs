...
namespace SegmentedView.Platforms.Android
{
    ...
    public class SegmentedControlRenderer : ViewRenderer<SegmentedControl, RadioGroup>
    {
        ...
        private Color _unselectedItemBackgroundColor = Color.Transparent;
        ...
        {
            return (int)TypedValue.ApplyDimension(ComplexUnitType.Dip, (float)dip, _context.Resources.DisplayMetrics);
        }
